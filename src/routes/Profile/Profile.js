            ...
            <div className='lower'>
                ...
                <div className='plansSection'>
                    <Link className='selectionContainers'>
                        ...
                        <p className='basicText'>Good video quality in SD (480p). Watch on any phone, tablet, computer or TV. $9.99/month</p>
                    </Link>
                    <Link className='selectionContainers'>
                        ...
                        <p className='basicText'>Great video quality in Full HD (1080p). Watch on any phone, tablet, computer or TV. $15.49/month</p>
                    </Link>
                    <Link className='selectionContainers'>
                        ...
                        <p className='basicText'>Our best video quality in Ultra HD (4K) and HDR. Watch on any phone, tablet, computer or TV. $19.99/month</p>
                    </Link>
